...
const getActualHoursDecimal = (task) => {
...
exports.getDailyReport = (0, async_handler_1.asyncHandler)(async (req, res) => {
    const localDateStr = req.query.localDate;
    if (!localDateStr || !/^\d{4}-\d{2}-\d{2}$/.test(localDateStr)) {
        throw new errors_1.ValidationError('localDate query parameter in YYYY-MM-DD format is required.');
    }
...
exports.getWeeklyReport = (0, async_handler_1.asyncHandler)(async (req, res) => {
    const localDateStr = req.query.localDate;
    if (!localDateStr || !/^\d{4}-\d{2}-\d{2}$/.test(localDateStr)) {
        throw new errors_1.ValidationError('localDate query parameter in YYYY-MM-DD format is required.');
    }
...
exports.getMonthlyReport = (0, async_handler_1.asyncHandler)(async (req, res) => {
    const localDateStr = req.query.localDate;
    if (!localDateStr || !/^\d{4}-\d{2}-\d{2}$/.test(localDateStr)) {
        throw new errors_1.ValidationError('localDate query parameter in YYYY-MM-DD format is required.');
    }
