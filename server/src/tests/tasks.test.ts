...
describe('Tasks API', () => {
  ...
  describe('GET /api/tasks', () => {
    ...
    it('should list tasks only belonging to the authenticated user', async () => {
      ...
      expect(res.body.data.tasks.every((t: any) => t.title !== 'User Two Task')).toBe(true);
    });
  ...
  describe('DELETE /api/tasks/:id', () => {
    ...
    it('should delete task successfully', async () => {
      ...
      const dbCheck = await Task.findById(taskId);
  ...
  describe('POST /api/tasks/bulk-complete & bulk-delete', () => {
    ...
    it('should bulk complete tasks successfully', async () => {
      ...
      const t1 = await Task.findById(task1Id);
      const t2 = await Task.findById(task2Id);
